...
@.str.17 = private unnamed_addr constant [11 x i8] c"i am test3\00", align 1
@.str.18 = private unnamed_addr constant [11 x i8] c"i am test4\00", align 1
@.str.19 = private unnamed_addr constant [11 x i8] c"i am test5\00", align 1
@.str.20 = private unnamed_addr constant [7 x i8] c"inline\00", align 1
@.str.21 = private unnamed_addr constant [10 x i8] c"I_AM_FLAG\00", align 1
@.str.22 = private unnamed_addr constant [9 x i8] c"flag: %s\00", align 1
@.str.23 = private unnamed_addr constant [42 x i8] c"basic_string::_M_construct null not valid\00", align 1
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_ZL9early_usev, ptr null }]
@.str.24 = private unnamed_addr constant [5 x i8] c"senc\00", section "llvm.metadata"
@.str.25 = private unnamed_addr constant [13 x i8] c"test_str.cpp\00", section "llvm.metadata"
@.str.26 = private unnamed_addr constant [9 x i8] c"test1234\00", section "llvm.metadata"
@llvm.global.annotations = appending global [3 x { ptr, ptr, ptr, i32, ptr }] [{ ptr, ptr, ptr, i32, ptr } { ptr @_Z5test3NSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE, ptr @.str.24, ptr @.str.25, i32 81, ptr null }, { ptr, ptr, ptr, i32, ptr } { ptr @_Z5test4PKc, ptr @.str.24, ptr @.str.25, i32 86, ptr null }, { ptr, ptr, ptr, i32, ptr } { ptr @_Z5test4PKc, ptr @.str.26, ptr @.str.25, i32 86, ptr null }], section "llvm.metadata"
...
invoke.cont7:                                     ; preds = %invoke.cont
  %call10 = invoke i32 @puts(ptr noundef @.str.16)
...
invoke.cont14:                                    ; preds = %invoke.cont12
  ...
  call void @_ZNSaIcED1Ev(ptr noundef nonnull align 1 dereferenceable(1) %ref.tmp) #7
  invoke void @_Z5test4PKc(ptr noundef @.str.18)
          to label %invoke.cont15 unwind label %lpad

invoke.cont15:                                    ; preds = %invoke.cont14
  invoke void @_Z5test5PKc(ptr noundef @.str.19)
          to label %invoke.cont16 unwind label %lpad

invoke.cont16:                                    ; preds = %invoke.cont15
  store i32 0, ptr %retval, align 4
  call void @_ZN7TestStrD2Ev(ptr noundef nonnull align 8 dereferenceable(40) %testStr) #7
  %2 = load i32, ptr %retval, align 4
  ret i32 %2

lpad:                                             ; preds = %invoke.cont15, %invoke.cont14, %invoke.cont7, %invoke.cont, %entry
...
entry:
  ...
  call void @_ZNSaIcEC1Ev(ptr noundef nonnull align 1 dereferenceable(1) %ref.tmp) #7
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2IS3_EEPKcRKS3_(ptr noundef nonnull align 8 dereferenceable(32) %flag, ptr noundef @.str.21, ptr noundef nonnull align 1 dereferenceable(1) %ref.tmp)
          to label %invoke.cont unwind label %lpad
...
entry:
  ...
  %call = call noundef ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4dataEv(ptr noundef nonnull align 8 dereferenceable(32) %s) #7
  invoke void %0(ptr noundef %call)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  %flag = getelementptr inbounds %class.TestStr, ptr %this1, i32 0, i32 1
  %call2 = call noundef ptr @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5c_strEv(ptr noundef nonnull align 8 dereferenceable(32) %flag) #7
  %call4 = invoke i32 (ptr, ...) @printf(ptr noundef @.str.22, ptr noundef %call2)
          to label %invoke.cont3 unwind label %lpad
...
entry:
  ...
  %this1 = load ptr, ptr %this.addr, align 8
  %flag = getelementptr inbounds %class.TestStr, ptr %this1, i32 0, i32 1
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(ptr noundef nonnull align 8 dereferenceable(32) %flag) #7
  ret void
}
...
if.then:                                          ; preds = %land.lhs.true
  call void @_ZSt19__throw_logic_errorPKc(ptr noundef @.str.23) #8
  unreachable
...
invoke.cont:                                      ; preds = %if.end6
  ...
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE13_S_copy_charsEPcPKcS7_(ptr noundef %call7, ptr noundef %8, ptr noundef %9) #7
  br label %try.cont
...
lpad:                                             ; preds = %if.end6
  ...
  %exn = load ptr, ptr %exn.slot, align 8
  %13 = call ptr @__cxa_begin_catch(ptr %exn) #7
