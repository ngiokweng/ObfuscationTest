...
@.str.25 = private unnamed_addr constant [9 x i8] c"fla-plus\00", section "llvm.metadata"
@.str.26 = private unnamed_addr constant [9 x i8] c"test.cpp\00", section "llvm.metadata"
@llvm.global.annotations = appending global [1 x { ptr, ptr, ptr, i32, ptr }] [{ ptr, ptr, ptr, i32, ptr } { ptr @_Z15controlFlowTesti, ptr @.str.25, ptr @.str.26, i32 70, ptr null }], section "llvm.metadata"
...
define dso_local noundef range(i32 100, 201) i32 @_Z5test2i(i32 noundef %a) local_unnamed_addr #6 personality ptr @__gxx_personality_v0 {
entry:
